# Этап 3. UX-анализ: Интерфейс и Сценарии

В данном разделе описаны основные экраны, состояния системы и сценарии взаимодействия пользователя с приложением **Splitflow**.
...
### Экран 1: Авторизация (Login Screen)
...
### Экран 2: Главная панель (Dashboard)
...
### Экран 3: Канбан-доска (Tasks Board)
...
### Экран 4: Список сотрудников (Employees)
